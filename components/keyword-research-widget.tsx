...
import { Search, ExternalLink, Target, TrendingUp, Lightbulb, BarChart3 } from "lucide-react"
import Link from "next/link"
import Image from "next/image"

export function KeywordResearchWidget() {
  ...
  return (
    ...
    >
      <CardHeader className="space-y-1 pb-2">
        ...
        <CardDescription>גלה מילות מפתח רווחיות ושפר את דירוג האתר שלך</CardDescription>
      </CardHeader>
      <CardContent className="p-0">
        <div className="relative aspect-video w-full overflow-hidden">
          ...
          ></div>
          <Image
            src="/images/seo-ai-tools.png"
            alt="מחקר מילות מפתח חכם"
            width={600}
            height={300}
          ...
          <div className="absolute bottom-4 left-4 right-4 z-20">
            ...
            >
              <Link href="/keyword-research" className="flex items-center justify-center gap-2">
                חקור מילות מפתח
